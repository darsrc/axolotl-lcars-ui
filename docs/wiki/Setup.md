...
latest upstream `main` branch directly from GitHub. Reinstall the requirements to refresh an
existing environment after LCARS WebUI changes. For local LCARS WebUI development, install your
checkout into the venv in editable mode after installing requirements:
